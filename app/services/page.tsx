    ...
    <>
      ...
      >
        ...
        <motion.section
          ...
          className="max-w-4xl mx-auto text-center mb-0" // reduced margin
        >
        ...
        {/* Testimonials */}
        <section className="max-w-4xl mx-auto my-20 relative">
                ...
                (testi, idx) =>
                  idx === currentTestimonial && (
                    ...
                    >
                      ...
                      <p className={`text-sm mb-3 ${subTextColor}`}>
                        {testi.role}
                      </p>
                    </motion.div>
                  )
        ...
        >
          ...
          <p className="mb-8 text-lg max-w-xl mx-auto text-white/80">
            Let&apos;s work together to create unforgettable campaigns that
